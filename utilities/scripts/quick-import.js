...
/**
 * Quick Import Script
 * Clears bot_config and imports data
 */
...
console.log('Clearing bot_config and importing data...\n');
...
async function importData() {
  try {
    ...
    // Clear bot_config first
    console.log('\n🗑️  Clearing bot_config table...');
    await db.execute('TRUNCATE TABLE "bot_config" CASCADE');
    console.log('✅ bot_config cleared');
